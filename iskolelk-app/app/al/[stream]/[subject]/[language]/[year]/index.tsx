...
import { useALPapers } from '@/hooks/usePapers';
...
export default function ALFinalScreen() {
  const { stream, subject, language, year } = useLocalSearchParams<{ stream?: string; subject?: string; language?: string; year?: string }>();
  ...
  // Fetch papers data
  const { papers, loading, error } = useALPapers(s, sub, lang, y);
  const papersArray = papers as any[];

  // Debug logging
  console.log('ALFinalScreen - papers:', papers);
  console.log('ALFinalScreen - loading:', loading);
  console.log('ALFinalScreen - error:', error);
  console.log('ALFinalScreen - papers length:', papers?.length);

  if (!streamMeta || !subjectMeta || !languageMeta || !y) {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.center}>
          <Text style={styles.error}>Invalid stream, subject, language, or year.</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  const renderPaperItem = ({ item }: { item: any }) => {
    ...
    return (
      <View style={styles.paperCard}>
        ...
        <Text style={styles.paperInfo}>Stream: {item.stream}</Text> */}
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        {/* <Text style={styles.title}>A/L Examination</Text> */}
        
        <View style={styles.infoCard}>
          <Text style={styles.label}>Exam Type:</Text>
          <Text style={styles.value}>Advanced Level (A/L)</Text>
        </View>
