...
export async function generateMetadata({ params }) {
  ...
  const pageTitle = `Download ${subject} Ordinary Level Past Papers and Marking Schemes | ${params.language.toUpperCase()} Medium`;
  const pageDescription = `Download ${subject} Ordinary Level past papers and marking scheme in ${params.language.toUpperCase()} medium. Includes marking schemes and solutions. Free access to past papers.`;
  
  return {
    title: pageTitle,
    description: pageDescription,
    keywords: `Download ${subject} ol past papers, Download ${subject} past exam papers, Download ${subject} past test papers, Download ${subject} past model papers, Download ${subject} past revision papers, Download ${subject} past study materials, ${subject}, Ordinary Level, OL, past papers, ${params.language.toUpperCase()} medium, marking scheme, solutions, Sri Lanka education, exam preparation`,
    openGraph: {
      title: pageTitle,
      description: pageDescription,
      type: 'website',
    ...
    alternates: {
      canonical: `${SITE_URL}/papers/ol/${params.subject}/${params.language}`,
    },
  };
}

// This function runs on the server side
async function getPapersData(subject, language, page = 1) {
  try {
...
export default async function OLSubjectPage({ params, searchParams }) {
  ...
  const data = await getPapersData(params.subject, language, currentPage);
  ...
  const generateStructuredData = () => {
    if (!papers || papers.length === 0) {
      return {
        ...
        "@type": "CollectionPage",
        "name": `Download ${subject} (O/L)Ordinary Level Past Papers and Marking Schemes - ${language.toUpperCase()} Medium`,
        "description": `Download ${subject} (O/L) Ordinary Level past papers in ${language.toUpperCase()} medium. Includes marking schemes and solutions.`,
        "about": {
    ...
    const paperList = papers.map(paper => ({
      ...
      "name": `Download ${subject} O/L ${paper.year} ${paper.session} Paper and Marking Scheme ${paper.paperNumber} - ${language.toUpperCase()} Medium`,
      "description": `Download ${subject} O/L past paper and Marking Scheme from ${paper.year} ${paper.session} session in ${language.toUpperCase()} medium.`,
      "educationalLevel": "Ordinary Level",
      "inLanguage": language,
            ...
            <div className="lg:col-span-3">
              <div className="max-w-4xl">
                <h1 className="text-4xl font-bold mb-4">
                  Download {subject} OL (Ordinary Level) Past Papers & Marking Schemes - {language.charAt(0).toUpperCase() + language.slice(1)} Medium
                </h1>
                
                <div className="prose prose-lg mb-8">
                  <p className="text-gray-600">
                    Download all {subject} O/L (Ordinary Level) past papers in {language.charAt(0).toUpperCase() + language.slice(1)} medium. 
                  ...
                  <>
                      ...
                      {papers.map((paper) => (
                        ...
                        >
                          <div className="flex justify-between items-start">
                            ...
                            <Link 
                              href={`/papers/ol/${params.subject}/${language}/${paper.year}`}
                    ...
                    <div className="mt-8">
                      <ServerPagination
                        ...
                        baseUrl={`/papers/ol/${params.subject}/${params.language}`}
              ...
              <SocialPromoBox variant="default" showDelay={0} dismissible={false} />
                ...
                <div className="mt-12 bg-gray-50 p-6 rounded-lg">
                  <h2 className="text-2xl font-semibold mb-4">About {subject} O/L (Ordinary Level) Past Papers - {language.charAt(0).toUpperCase() + language.slice(1)} Medium</h2>
                ...
                <div className="mt-8 bg-green-50 p-6 rounded-lg">
                  <h2 className="text-2xl font-semibold mb-4 text-green-800">Tips for Using {language.charAt(0).toUpperCase() + language.slice(1)} Medium Past Papers Effectively</h2>
                  <div className="prose prose-lg">
                ...
                <div className="mt-8 bg-blue-50 p-6 rounded-lg">
                    <h2 className="text-2xl font-semibold mb-4 text-blue-800">Additional Resources for {language.charAt(0).toUpperCase() + language.slice(1)} Medium</h2>
                  <div className="prose prose-lg">
                ...
                <div className="mt-8 bg-purple-50 p-6 rounded-lg">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">
                      Ordinary Level {subject} {language.charAt(0).toUpperCase() + language.slice(1)}
                    </span>
