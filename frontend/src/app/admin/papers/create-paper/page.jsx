...
import { createPaperLocal, createPaperS3, createPaperR2 } from '@/actions/papers'
...
const CreatePaperPage = () => {
  ...
  const getAvailableSubjects = () => {
    if (examType === 'al' && stream) {
      ...
      return ['maths', 'english', 'sinhala', 'tamil']
    }
    return []
  }
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (storageType === 'local') {
        ...
        await createPaperR2(formData)
      } else {
        await createPaperS3(formData)
      }
